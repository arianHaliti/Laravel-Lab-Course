...
<div class="col-md-4 p-0 p-2 mt-2 mb-2 ">
    ...
    <a href="/course/{{$lesson->lesson_id}}/{{$c->course_title}}/{{$lesson->lesson_title}}"><img src="/storage/image/photo.jpg" class="w-100"></a>
    ...
    <div class="col-md-12 float-left p-0"><img src="/storage/image/photo.jpg" class="user-pic float-left rounded-circle mr-1"><p class="f-12 float-left mt-1 mb-1">{{$user->username}}, {{$c->created_at->format('d/m/y')}}</p></div>
</div>
</div>
@endif